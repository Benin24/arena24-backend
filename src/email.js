// ============================================================
// Arena 24 — Email Service via Brevo HTTP API
// No SMTP ports needed — works 100% on Render free tier
// ============================================================
...
const sendEmail = async ({ to, subject, html }) => {
  const payload = JSON.stringify({
    sender: {
      name: 'Arena 24',
      email: 'a4447d001@smtp-brevo.com'
    },
    to: [{ email: to }],
    subject,
    htmlContent: html
...
<head>
  <meta charset="UTF-8">
  <style>
    body { font-family: Arial, sans-serif; background: #080b12; color: #fff; margin: 0; padding: 0; }
    .container { max-width: 600px; margin: 0 auto; padding: 40px 20px; }
    .logo { font-size: 28px; color: #ff6b00; font-weight: 900; letter-spacing: 2px; }
...
<body>
  <div class="container">
    ...
    <div class="footer">
      ...
      <p>If you did not register on Arena 24, please ignore this email.</p>
    </div>
  </div>
</body>
</html>
...
const sendVerificationEmail = async (email, username, token) => {
  ...
  await sendEmail({
    ...
    html: baseTemplate(`
      ...
      <p>You are one step away from joining India's most competitive gaming tournament platform.</p>
  ...
  await sendEmail({
    ...
    html: baseTemplate(`
      ...
      <table style="width:100%;border-collapse:collapse;margin:16px 0">
        ...
        <tr><td style="color:#888;padding:8px 0">Prize Pool</td><td style="color:#ff6b00;font-weight:bold">Rs.${tournament.prize_pool}</td></tr>
      </table>
  ...
  await sendEmail({
    ...
    html: baseTemplate(`
      ...
      <table style="width:100%;border-collapse:collapse;margin:16px 0">
        ...
        <tr><td style="color:#888;padding:8px 0">Amount</td><td style="color:#ff6b00;font-weight:bold">Rs.${details.amount}</td></tr>
  ...
  await sendEmail({
    ...
    html: baseTemplate(`
      ...
      <table style="width:100%;border-collapse:collapse;margin:16px 0">
        ...
        <tr><td style="color:#888;padding:8px 0">Prize Amount</td><td style="color:#00ff88;font-weight:bold;font-size:20px">Rs.${details.amount}</td></tr>
